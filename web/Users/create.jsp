    ...
    <div class="container">
        ...
        <form action="Users?action=insert" method="POST" autocomplete="off">
          ...
          <div class="row mb-4">
            ...
            <div class="col">
              <div class="form-outline">
                ...
                <input type="text" id="form6Example2" class="form-control" name="documentNumber" value=""/>
              </div>
            </div>
          </div>
          <div class="row mb-4">
            ...
            <div class="col">
              <div class="form-outline">
                ...
                <input type="text" id="form6Example2" class="form-control" name="phono" value=""/>
              </div>
            </div>
          </div>
          ...
          <div class="form-outline mb-4">
            ...
            <input type="text" name="email" value="" id="form6Example3" class="form-control" />
          </div>
